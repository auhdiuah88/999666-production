...
class BrYbPay extends PayStrategy
{
    ...
    protected static $url = 'http://bra.polymerizations.com/poi/pay/index/PayOrderCreate';    // 支付网关

    protected static $url_cashout = 'http://bra.polymerizations.com/poi/dai/index/DaiOrderCreate'; // 提现网关
