...
class SystemService extends Service
{
    ...
    public function getH5Alert()
    {
        ...
        $login_alert = $login_value ? htmlspecialchars_decode(htmlspecialchars_decode($login_value['content'])) : "";
        $logout_alert = $logout_value ? htmlspecialchars_decode(htmlspecialchars_decode($logout_value['content'])) : "";
